# -*- coding: utf-8 -*-
"""
Created on Sun Aug  2 10:15:58 2020
...
class my_pre_weighted_transfer_learning_model(nn.Module):
...
detr = my_pre_weighted_transfer_learning_model(num_classes=91)
...
while(cap.isOpened()):
    ...
    if (frameId % math.floor(frameRate) == 0):
        filename = imagesFolder+"/"+str(cnt)+ ".jpg"
...
def plot_results(pil_img, prob, boxes):
    ...
    for p, (xmin, ymin, xmax, ymax), c in zip(prob, boxes.tolist(), COLORS * 100):
        ...
        ax.text(xmin, ymin, text, fontsize=25,
